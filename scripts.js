...
if(newsContainer){
    fetch("https://newsapi.org/v1/articles?source=bbc-news&apiKey=1985f157246a4e19958fafd98f1e3e47")
        .then(response => {
            return response.json();
        }).then(news => {
...
if(askJack){
    const askJackFormSubmit = e => {
        ...
        fetch("https://jodiepebble.github.io/DFMcopy/first.html", {mode: "no-cors", method: "POST", body: contact})
            .then(response => {
